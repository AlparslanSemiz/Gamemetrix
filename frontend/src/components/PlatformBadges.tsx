...
const PsIcon = (props: BadgeIconProps) => (
  <BrandIcon {...props} paths={[
...
const XboxIcon = (props: BadgeIconProps) => (
  <BrandIcon {...props} paths={[
...
const NintendoIcon = (props: BadgeIconProps) => (
  <BrandIcon {...props} paths={[
...
const AppleIcon = ({ size = 16 }: BadgeIconProps) => (
...
function platformIcon(className: string) {
  switch (className) {
    ...
    case 'platform-mac': return AppleIcon
