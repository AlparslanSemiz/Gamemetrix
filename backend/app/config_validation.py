...
def _nonnegative_settings(s: "Settings") -> dict[str, float]:
    return {
        ...
        "GEMINI_DAILY_TOKEN_LIMIT": s.GEMINI_DAILY_TOKEN_LIMIT,
        "CLOUDFLARE_AI_DAILY_LIMIT": s.CLOUDFLARE_AI_DAILY_LIMIT,
        "CLOUDFLARE_AI_DAILY_TOKEN_LIMIT": s.CLOUDFLARE_AI_DAILY_TOKEN_LIMIT,
        "OPENROUTER_DAILY_LIMIT": s.OPENROUTER_DAILY_LIMIT,
        "OPENROUTER_DAILY_TOKEN_LIMIT": s.OPENROUTER_DAILY_TOKEN_LIMIT,
        "SIMILARITY_AI_DAILY_LIMIT": s.SIMILARITY_AI_DAILY_LIMIT,
...
def _positive_settings(s: "Settings") -> dict[str, float]:
    return {
        ...
        "DATA_FILL_SYSTEM_REQUIREMENTS_BATCH_SIZE": s.DATA_FILL_SYSTEM_REQUIREMENTS_BATCH_SIZE,
...
def _delay_settings(s: "Settings") -> dict[str, float]:
    return {
        ...
        "SIMILARITY_AI_MIN_INTERVAL_SECONDS": s.SIMILARITY_AI_MIN_INTERVAL_SECONDS,
    }
